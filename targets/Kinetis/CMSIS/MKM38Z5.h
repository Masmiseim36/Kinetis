...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MKM38Z5
**
 ...
 * @version 1.2
 * @date 2015-07-23
 * @brief CMSIS Peripheral Access Layer for MKM38Z5
 *
 * CMSIS Peripheral Access Layer for MKM38Z5
 */

#if !defined(MKM38Z5_H_)
#define MKM38Z5_H_                               /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  AFE3_IRQn                    = 24,               /**< AFE Channel 3 ORed Interrupt */
...
#include "system_MKM38Z5.h"            /* Device specific configuration file */
