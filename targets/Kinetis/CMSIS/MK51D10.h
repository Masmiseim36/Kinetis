...
#if !defined(MK51D10_H_)
#define MK51D10_H_                               /**< Symbol preventing repeated inclusion */
...
typedef struct {
  __IO uint32_t CONTROL;                           /**< Control Register..Control Register, offset: 0x0 */
