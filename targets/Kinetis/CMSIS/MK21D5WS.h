...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MK21D5WS
**
 ...
 * @version 1.3
 * @date 2013-06-24
 * @brief CMSIS Peripheral Access Layer for MK21D5WS
 *
 * CMSIS Peripheral Access Layer for MK21D5WS
 */

#if !defined(MK21D5WS_H_)
#define MK21D5WS_H_                              /**< Symbol preventing repeated inclusion */
...
#include "system_MK21D5WS.h"           /* Device specific configuration file */
...
typedef struct {
  ...
  __IO uint32_t PGFR[3];                           /**< DryIce Pin Glitch Filter Register, array offset: 0x40, array step: 0x4 */
