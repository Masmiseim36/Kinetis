...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MKM32Z5
**
 ...
 * @version 1.2
 * @date 2015-07-23
 * @brief CMSIS Peripheral Access Layer for MKM32Z5
 *
 * CMSIS Peripheral Access Layer for MKM32Z5
 */

#if !defined(MKM32Z5_H_)
#define MKM32Z5_H_                               /**< Symbol preventing repeated inclusion */
...
#include "system_MKM32Z5.h"            /* Device specific configuration file */
