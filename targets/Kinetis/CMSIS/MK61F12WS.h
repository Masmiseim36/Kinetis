...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MK61F12WS
**
 ...
 * @version 1.2
 * @date 2013-06-24
 * @brief CMSIS Peripheral Access Layer for MK61F12WS
 *
 * CMSIS Peripheral Access Layer for MK61F12WS
 */

#if !defined(MK61F12WS_H_)
#define MK61F12WS_H_                             /**< Symbol preventing repeated inclusion */
...
#include "system_MK61F12WS.h"          /* Device specific configuration file */
...
#define DRY_CR_THYD_MASK                         DRY_CR_THYS_MASK
#define DRY_CR_THYD_SHIFT                        DRY_CR_THYS_SHIFT
